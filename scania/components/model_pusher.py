from scania.predictor import ModelResolver
from scania.entity.config_entity import ModelPusherConfig
from scania.exception import ScaniaException
import os,sys
from scania.utils import load_object,save_object
from scania.logger import logging
from scania.entity.artifact_entity import DataTransformationArtifact,ModelTrainerArtifact,ModelPusherArtifact
class ModelPusher:
